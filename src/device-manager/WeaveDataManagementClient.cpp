                                     ...
                                     const SubscriptionClient::InEventParam & aInParam, SubscriptionClient::OutEventParam & aOutParam)
{
    ...
    switch (aEvent)
    {
        ...
        case SubscriptionClient::kEvent_OnSubscriptionEstablished:
            ...
            pWDMDMClient->mOnComplete.General(pWDMDMClient->mpContext, pWDMDMClient->mpAppReqState);
...
exit:
    if (WEAVE_NO_ERROR != err)
    {
        ...
        pWDMDMClient->mOnError(pWDMDMClient->mpContext, pWDMDMClient->mpAppReqState, err, NULL);
        pWDMDMClient->mpContext = NULL;
        pWDMDMClient->ClearOpState();
    }
