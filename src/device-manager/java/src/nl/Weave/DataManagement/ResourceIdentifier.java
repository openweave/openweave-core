...
public class ResourceIdentifier
{
    ...
    {
        ResourceIdentifier resourceIdentifier = new ResourceIdentifier(resourceType, resourceId.longValue());
    ...
    public static ResourceIdentifier make(int resourceType, byte[] resourceIdBytes)
    {
        ...
        ResourceIdentifier resourceIdentifier = new ResourceIdentifier(resourceType, byteArrayToLong(resourceIdBytes));
        return resourceIdentifier;
    }
