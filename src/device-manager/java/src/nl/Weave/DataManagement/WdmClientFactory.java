...
{
    /**
     * Create WdmClient, connect to device manager and reuse the existing connection from device manager
     *
     * @param deviceManager weave device manager
     *
     */
