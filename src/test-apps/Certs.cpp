...
// Operational credentials: node Id, self-signed certificate, service-assigned certificate and private key for Test Device 1
//

uint64_t TestDevice1_OperationalNodeId = 0x1AB4300000000001ULL;

uint8_t TestDevice1_OperationalSelfSignedCert[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x30, 0x01, 0x08, 0x43, 0xF3, 0x12, 0x58, 0x7C, 0xD6,
    0x7E, 0x03, 0x24, 0x02, 0x05, 0x37, 0x03, 0x27, 0x11, 0x01, 0x00, 0x00, 0x00, 0x00, 0x30, 0xB4,
    ...
    ,
};

uint16_t TestDevice1_OperationalSelfSignedCertLength = sizeof(TestDevice1_OperationalSelfSignedCert);

uint8_t TestDevice1_OperationalServiceAssignedCert[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x30, 0x01, 0x08, 0x51, 0x77, 0xC2, 0xBF, 0x9F, 0x52,
    0xDB, 0xFA, 0x24, 0x02, 0x05, 0x37, 0x03, 0x27, 0x11, 0x02, 0x00, 0x00, 0xFF, 0xEE, 0x30, 0xB4,
    0x18, 0x18, 0x26, 0x04, 0x2A, 0x07, 0x85, 0x25, 0x26, 0x05, 0x2A, 0x53, 0xAD, 0x38, 0x37, 0x06,
    0x27, 0x11, 0x01, 0x00, 0x00, 0x00, 0x00, 0x30, 0xB4, 0x1A, 0x18, 0x24, 0x07, 0x02, 0x26, 0x08,
    0x1B, 0x00, 0x5A, 0x23, 0x30, 0x0A, 0x41, 0x04, 0x3D, 0x12, 0x47, 0xA8, 0x22, 0x9C, 0xC1, 0xF8,
    0x09, 0x69, 0x5A, 0x97, 0xAC, 0x74, 0x7E, 0x68, 0x65, 0x53, 0x3F, 0xFD, 0x4C, 0x6B, 0x46, 0xD4,
    0x70, 0xA4, 0x7C, 0xF7, 0xE3, 0x15, 0x29, 0x58, 0x44, 0x84, 0x7D, 0x8E, 0x01, 0x5A, 0xC3, 0x2B,
    ...
    0x01, 0x24, 0x02, 0x05, 0x18, 0x35, 0x84, 0x29, 0x01, 0x36, 0x02, 0x04, 0x02, 0x04, 0x01, 0x18,
    0x18, 0x35, 0x81, 0x30, 0x02, 0x08, 0x47, 0x3B, 0xCD, 0x88, 0xE3, 0x02, 0x39, 0xA1, 0x18, 0x35,
    0x80, 0x30, 0x02, 0x08, 0x46, 0xF3, 0xF1, 0xAF, 0xDE, 0x30, 0x78, 0x9F, 0x18, 0x35, 0x0C, 0x30,
    0x01, 0x1C, 0x26, 0x7C, 0x51, 0xA7, 0x23, 0xB9, 0xE0, 0x0B, 0x47, 0xBF, 0xB0, 0x12, 0x56, 0xF1,
    0x7C, 0x37, 0x02, 0x00, 0x99, 0x60, 0x8F, 0xEB, 0x2C, 0xDD, 0xC5, 0x4C, 0xF0, 0xF2, 0x30, 0x02,
    0x1D, 0x00, 0xE4, 0x8F, 0xA8, 0x92, 0xBE, 0xE2, 0xDE, 0xD9, 0xC3, 0x14, 0x4C, 0xD5, 0x19, 0x6E,
    0xEC, 0x97, 0x09, 0x58, 0x8D, 0x26, 0x7D, 0xDD, 0x66, 0x81, 0x34, 0x17, 0xEC, 0x03, 0x18, 0x18,
};

uint16_t TestDevice1_OperationalServiceAssignedCertLength = sizeof(TestDevice1_OperationalServiceAssignedCert);

uint8_t TestDevice1_OperationalPrivateKey[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x02, 0x00, 0x26, 0x01, 0x1B, 0x00, 0x5A, 0x23, 0x30, 0x02, 0x20,
    0x9F, 0x68, 0xC0, 0x32, 0x36, 0x9E, 0xE6, 0xD7, 0xD5, 0x31, 0xF3, 0xC0, 0x87, 0x7D, 0x95, 0x2C,
    0x1C, 0x43, 0xC8, 0xCA, 0x66, 0xBF, 0x45, 0xC9, 0x95, 0x28, 0x56, 0x5B, 0x40, 0xF7, 0xFB, 0x9E,
    0x30, 0x03, 0x41, 0x04, 0x3D, 0x12, 0x47, 0xA8, 0x22, 0x9C, 0xC1, 0xF8, 0x09, 0x69, 0x5A, 0x97,
    0xAC, 0x74, 0x7E, 0x68, 0x65, 0x53, 0x3F, 0xFD, 0x4C, 0x6B, 0x46, 0xD4, 0x70, 0xA4, 0x7C, 0xF7,
    0xE3, 0x15, 0x29, 0x58, 0x44, 0x84, 0x7D, 0x8E, 0x01, 0x5A, 0xC3, 0x2B, 0xC9, 0x32, 0x53, 0x5C,
    0xC4, 0x44, 0x03, 0xDA, 0xF6, 0x83, 0x2E, 0x49, 0x78, 0xC8, 0x1E, 0x0E, 0x7C, 0x9B, 0x27, 0xCD,
    0xB2, 0xC6, 0x59, 0x27, 0x18,
};

uint16_t TestDevice1_OperationalPrivateKeyLength = sizeof(TestDevice1_OperationalPrivateKey);


// Operational credentials: node Id, self-signed certificate, service-assigned certificate and private key for Test Device 2
//

uint64_t TestDevice2_OperationalNodeId = 0x1AB4300000000002ULL;

uint8_t TestDevice2_OperationalSelfSignedCert[] =
{
    ,
};

uint16_t TestDevice2_OperationalSelfSignedCertLength = sizeof(TestDevice2_OperationalSelfSignedCert);

uint8_t TestDevice2_OperationalServiceAssignedCert[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x30, 0x01, 0x08, 0x55, 0x03, 0x83, 0x06, 0x12, 0x80,
    0x15, 0x37, 0x24, 0x02, 0x05, 0x37, 0x03, 0x27, 0x11, 0x02, 0x00, 0x00, 0xFF, 0xEE, 0x30, 0xB4,
    0x18, 0x18, 0x26, 0x04, 0x2A, 0x07, 0x85, 0x25, 0x26, 0x05, 0x2A, 0x53, 0xAD, 0x38, 0x37, 0x06,
    0x27, 0x11, 0x02, 0x00, 0x00, 0x00, 0x00, 0x30, 0xB4, 0x1A, 0x18, 0x24, 0x07, 0x02, 0x26, 0x08,
    0x1B, 0x00, 0x5A, 0x23, 0x30, 0x0A, 0x41, 0x04, 0xD0, 0x06, 0x73, 0xD8, 0x0D, 0x67, 0xBE, 0x1E,
    0x14, 0x59, 0x1D, 0xEC, 0xFD, 0x36, 0x4A, 0xF4, 0x2D, 0x30, 0x01, 0x51, 0xF1, 0xB6, 0x8F, 0xAA,
    ...
    0x18, 0x35, 0x81, 0x30, 0x02, 0x08, 0x48, 0x10, 0x9A, 0x7A, 0xF4, 0x9C, 0x1F, 0x9E, 0x18, 0x35,
    0x80, 0x30, 0x02, 0x08, 0x46, 0xF3, 0xF1, 0xAF, 0xDE, 0x30, 0x78, 0x9F, 0x18, 0x35, 0x0C, 0x30,
    0x01, 0x1C, 0x04, 0x81, 0x45, 0xDF, 0xCE, 0xD8, 0x3B, 0x52, 0x2D, 0x59, 0xE6, 0xEA, 0xCF, 0x37,
    0xBE, 0x2B, 0x09, 0xE6, 0xA8, 0xF8, 0xAB, 0x93, 0xCA, 0xCA, 0x46, 0x6E, 0x8D, 0x9F, 0x30, 0x02,
    0x1D, 0x00, 0x8A, 0x56, 0x5B, 0x30, 0xEE, 0xA2, 0x1A, 0x5F, 0xE2, 0x32, 0x8C, 0x5C, 0x64, 0x62,
    0xD6, 0x26, 0x55, 0x0C, 0xC6, 0xA9, 0x22, 0x24, 0x0A, 0x85, 0xE3, 0x20, 0x44, 0x85, 0x18, 0x18,
};

uint16_t TestDevice2_OperationalServiceAssignedCertLength = sizeof(TestDevice2_OperationalServiceAssignedCert);

uint8_t TestDevice2_OperationalPrivateKey[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x02, 0x00, 0x26, 0x01, 0x1B, 0x00, 0x5A, 0x23, 0x30, 0x02, 0x20,
    0x96, 0x15, 0x84, 0xC4, 0x38, 0x27, 0x2B, 0xF6, 0xAB, 0x37, 0x7A, 0x4F, 0x1A, 0x79, 0xF7, 0xAA,
    0x54, 0xD6, 0xBD, 0x96, 0x2F, 0x71, 0xD5, 0x39, 0x79, 0xF2, 0x46, 0x00, 0x8B, 0x73, 0x79, 0xAA,
    0x30, 0x03, 0x41, 0x04, 0xD0, 0x06, 0x73, 0xD8, 0x0D, 0x67, 0xBE, 0x1E, 0x14, 0x59, 0x1D, 0xEC,
    0xFD, 0x36, 0x4A, 0xF4, 0x2D, 0x30, 0x01, 0x51, 0xF1, 0xB6, 0x8F, 0xAA, 0x0F, 0x5D, 0x17, 0x37,
    0x8B, 0xFF, 0x9D, 0xEF, 0x01, 0x55, 0x24, 0x44, 0x61, 0x65, 0xE7, 0x0A, 0x7C, 0x3D, 0xE1, 0x22,
    0xBF, 0xFD, 0x30, 0x47, 0x70, 0x6D, 0x3C, 0xCC, 0x22, 0x01, 0x11, 0x76, 0x65, 0x04, 0x37, 0x15,
    0x1A, 0x15, 0x33, 0xF8, 0x18,
};

uint16_t TestDevice2_OperationalPrivateKeyLength = sizeof(TestDevice2_OperationalPrivateKey);


// Operational credentials: node Id, self-signed certificate, service-assigned certificate and private key for Test Device 3
//

uint64_t TestDevice3_OperationalNodeId = 0x1AB4300000000003ULL;

uint8_t TestDevice3_OperationalSelfSignedCert[] =
{
    ,
};

uint16_t TestDevice3_OperationalSelfSignedCertLength = sizeof(TestDevice3_OperationalSelfSignedCert);

uint8_t TestDevice3_OperationalServiceAssignedCert[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x30, 0x01, 0x08, 0x78, 0x6E, 0x89, 0x66, 0x5D, 0xFF,
    0x6F, 0xF6, 0x24, 0x02, 0x05, 0x37, 0x03, 0x27, 0x11, 0x02, 0x00, 0x00, 0xFF, 0xEE, 0x30, 0xB4,
    0x18, 0x18, 0x26, 0x04, 0x2A, 0x07, 0x85, 0x25, 0x26, 0x05, 0x2A, 0x53, 0xAD, 0x38, 0x37, 0x06,
    0x27, 0x11, 0x03, 0x00, 0x00, 0x00, 0x00, 0x30, 0xB4, 0x1A, 0x18, 0x24, 0x07, 0x02, 0x26, 0x08,
    0x1B, 0x00, 0x5A, 0x23, 0x30, 0x0A, 0x41, 0x04, 0x74, 0xD5, 0x96, 0x22, 0xFD, 0xB8, 0x59, 0xCF,
    0x05, 0x8D, 0xA9, 0xE7, 0x97, 0x55, 0x6D, 0x71, 0xA9, 0xC6, 0x3E, 0xC0, 0xDD, 0x5C, 0xA8, 0xE8,
    ...
    0x18, 0x35, 0x81, 0x30, 0x02, 0x08, 0x4A, 0x44, 0x68, 0x59, 0xE0, 0x12, 0x5B, 0x01, 0x18, 0x35,
    0x80, 0x30, 0x02, 0x08, 0x46, 0xF3, 0xF1, 0xAF, 0xDE, 0x30, 0x78, 0x9F, 0x18, 0x35, 0x0C, 0x30,
    0x01, 0x1C, 0x4C, 0x71, 0x90, 0xCE, 0x72, 0x22, 0x7C, 0x58, 0xBC, 0x5C, 0x82, 0xF9, 0x83, 0x8C,
    0xFC, 0x43, 0x47, 0x4E, 0x58, 0x4C, 0xE6, 0xE0, 0xA0, 0x31, 0x0F, 0x83, 0xB8, 0x02, 0x30, 0x02,
    0x1C, 0x78, 0x8C, 0x58, 0x6F, 0x15, 0xD7, 0xBA, 0x5D, 0x2E, 0xAA, 0x0D, 0xC8, 0xA7, 0x91, 0xBD,
    0xD6, 0x84, 0x85, 0x30, 0x7C, 0x6A, 0x03, 0x42, 0x18, 0x68, 0x8C, 0x73, 0x3C, 0x18, 0x18,
};

uint16_t TestDevice3_OperationalServiceAssignedCertLength = sizeof(TestDevice3_OperationalServiceAssignedCert);

uint8_t TestDevice3_OperationalPrivateKey[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x02, 0x00, 0x26, 0x01, 0x1B, 0x00, 0x5A, 0x23, 0x30, 0x02, 0x20,
    0xAD, 0xBD, 0xE4, 0xEE, 0xF7, 0xCB, 0x4D, 0x39, 0x93, 0xFE, 0xFA, 0xE3, 0xBD, 0x9A, 0x7C, 0xFB,
    0x9B, 0x27, 0xF0, 0x27, 0x6E, 0x79, 0x64, 0x6A, 0xF5, 0xC6, 0x40, 0x39, 0x77, 0x17, 0x58, 0xC7,
    0x30, 0x03, 0x41, 0x04, 0x74, 0xD5, 0x96, 0x22, 0xFD, 0xB8, 0x59, 0xCF, 0x05, 0x8D, 0xA9, 0xE7,
    0x97, 0x55, 0x6D, 0x71, 0xA9, 0xC6, 0x3E, 0xC0, 0xDD, 0x5C, 0xA8, 0xE8, 0x4F, 0xEE, 0x86, 0xE8,
    0xCA, 0x74, 0xC4, 0x70, 0x71, 0x64, 0xBF, 0x6C, 0x8E, 0x37, 0xA1, 0x63, 0x13, 0xC9, 0x6B, 0x59,
    0x8C, 0xDE, 0xAB, 0xD3, 0x43, 0x2C, 0x2F, 0x29, 0x1A, 0x4A, 0x1C, 0x3A, 0xDE, 0x53, 0x57, 0x25,
    0x38, 0x00, 0x8E, 0xCC, 0x18,
};

uint16_t TestDevice3_OperationalPrivateKeyLength = sizeof(TestDevice3_OperationalPrivateKey);


// Operational credentials: node Id, self-signed certificate, service-assigned certificate and private key for Test Device 4
//

uint64_t TestDevice4_OperationalNodeId = 0x1AB4300000000004ULL;

uint8_t TestDevice4_OperationalSelfSignedCert[] =
{
    ,
};

uint16_t TestDevice4_OperationalSelfSignedCertLength = sizeof(TestDevice4_OperationalSelfSignedCert);

uint8_t TestDevice4_OperationalServiceAssignedCert[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x30, 0x01, 0x08, 0x7D, 0x7D, 0x1D, 0x27, 0x93, 0x00,
    0xCA, 0xF8, 0x24, 0x02, 0x05, 0x37, 0x03, 0x27, 0x11, 0x02, 0x00, 0x00, 0xFF, 0xEE, 0x30, 0xB4,
    0x18, 0x18, 0x26, 0x04, 0x2A, 0x07, 0x85, 0x25, 0x26, 0x05, 0x2A, 0x53, 0xAD, 0x38, 0x37, 0x06,
    0x27, 0x11, 0x04, 0x00, 0x00, 0x00, 0x00, 0x30, 0xB4, 0x1A, 0x18, 0x24, 0x07, 0x02, 0x26, 0x08,
    0x1B, 0x00, 0x5A, 0x23, 0x30, 0x0A, 0x41, 0x04, 0xCF, 0xE5, 0x55, 0x0D, 0x38, 0xA2, 0x25, 0x2C,
    0x8C, 0x87, 0xC1, 0x9F, 0x34, 0x6B, 0xFE, 0x4D, 0xA5, 0xD4, 0x0D, 0xE7, 0x24, 0x08, 0x60, 0x27,
    ...
    0x18, 0x35, 0x81, 0x30, 0x02, 0x08, 0x45, 0x8E, 0x66, 0x1B, 0x3B, 0x47, 0xA0, 0x28, 0x18, 0x35,
    0x80, 0x30, 0x02, 0x08, 0x46, 0xF3, 0xF1, 0xAF, 0xDE, 0x30, 0x78, 0x9F, 0x18, 0x35, 0x0C, 0x30,
    0x01, 0x1C, 0x31, 0xB1, 0xCE, 0x52, 0x6E, 0x39, 0x35, 0x8A, 0x87, 0xE1, 0x1F, 0xFA, 0x4A, 0x6C,
    0x40, 0x06, 0x3E, 0xA8, 0xBB, 0xC5, 0x7C, 0xBD, 0x6C, 0x5C, 0x91, 0x5C, 0x80, 0xE4, 0x30, 0x02,
    0x1D, 0x00, 0xE8, 0xDA, 0x89, 0x7E, 0x10, 0xCE, 0x7F, 0xFF, 0xCA, 0xA9, 0x5D, 0x45, 0xA0, 0x4E,
    0x20, 0x35, 0x60, 0xA4, 0x1D, 0x0D, 0x82, 0xE3, 0x4E, 0x73, 0x89, 0x17, 0x8D, 0xC8, 0x18, 0x18,
};

uint16_t TestDevice4_OperationalServiceAssignedCertLength = sizeof(TestDevice4_OperationalServiceAssignedCert);

uint8_t TestDevice4_OperationalPrivateKey[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x02, 0x00, 0x26, 0x01, 0x1B, 0x00, 0x5A, 0x23, 0x30, 0x02, 0x20,
    0x31, 0x24, 0x26, 0xD7, 0x49, 0x14, 0x4C, 0x40, 0x54, 0x94, 0x0C, 0xF5, 0x21, 0x32, 0x44, 0xD5,
    0xDA, 0xBD, 0x2A, 0x3F, 0x8B, 0x8B, 0xDE, 0x13, 0x97, 0xF9, 0x1E, 0x4E, 0x11, 0x82, 0xFE, 0xCB,
    0x30, 0x03, 0x41, 0x04, 0xCF, 0xE5, 0x55, 0x0D, 0x38, 0xA2, 0x25, 0x2C, 0x8C, 0x87, 0xC1, 0x9F,
    0x34, 0x6B, 0xFE, 0x4D, 0xA5, 0xD4, 0x0D, 0xE7, 0x24, 0x08, 0x60, 0x27, 0xB1, 0xC6, 0xA4, 0x63,
    0x10, 0x4A, 0x52, 0xDF, 0x83, 0xEC, 0x37, 0xCF, 0x59, 0x10, 0x41, 0xB7, 0x4B, 0xCF, 0x58, 0x39,
    0xE4, 0xCB, 0x66, 0xB7, 0xE5, 0x70, 0x6D, 0x09, 0xC0, 0xAC, 0x91, 0xD8, 0x11, 0x75, 0xF8, 0x97,
    0xAC, 0x98, 0xD4, 0xF0, 0x18,
};

uint16_t TestDevice4_OperationalPrivateKeyLength = sizeof(TestDevice4_OperationalPrivateKey);


// Operational credentials: node Id, self-signed certificate, service-assigned certificate and private key for Test Device 5
//

uint64_t TestDevice5_OperationalNodeId = 0x1AB4300000000005ULL;

uint8_t TestDevice5_OperationalSelfSignedCert[] =
{
    ,
};

uint16_t TestDevice5_OperationalSelfSignedCertLength = sizeof(TestDevice5_OperationalSelfSignedCert);

uint8_t TestDevice5_OperationalServiceAssignedCert[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x30, 0x01, 0x08, 0x79, 0xFC, 0xFC, 0x7F, 0xC5, 0xAD,
    0xEC, 0x49, 0x24, 0x02, 0x05, 0x37, 0x03, 0x27, 0x11, 0x02, 0x00, 0x00, 0xFF, 0xEE, 0x30, 0xB4,
    0x18, 0x18, 0x26, 0x04, 0x2A, 0x07, 0x85, 0x25, 0x26, 0x05, 0x2A, 0x53, 0xAD, 0x38, 0x37, 0x06,
    0x27, 0x11, 0x05, 0x00, 0x00, 0x00, 0x00, 0x30, 0xB4, 0x1A, 0x18, 0x24, 0x07, 0x02, 0x26, 0x08,
    0x1B, 0x00, 0x5A, 0x23, 0x30, 0x0A, 0x41, 0x04, 0x3E, 0xE5, 0xEC, 0xFA, 0xED, 0x68, 0xF1, 0x28,
    0xB3, 0xCE, 0xC2, 0x4D, 0x96, 0x7F, 0x3E, 0xC2, 0xF8, 0x29, 0x23, 0x8E, 0x43, 0xCC, 0xDE, 0x07,
    ...
    0x18, 0x35, 0x81, 0x30, 0x02, 0x08, 0x42, 0x2B, 0x66, 0x66, 0x24, 0x21, 0x35, 0xF1, 0x18, 0x35,
    0x80, 0x30, 0x02, 0x08, 0x46, 0xF3, 0xF1, 0xAF, 0xDE, 0x30, 0x78, 0x9F, 0x18, 0x35, 0x0C, 0x30,
    0x01, 0x1C, 0x1B, 0x9F, 0xCE, 0x42, 0xA9, 0x9E, 0x74, 0x5D, 0x8A, 0x1C, 0x0B, 0x21, 0x5E, 0x1C,
    0xBE, 0xD9, 0x56, 0x50, 0xA5, 0xF6, 0x95, 0x6D, 0x3F, 0x5D, 0x9C, 0x1F, 0xE6, 0x6E, 0x30, 0x02,
    0x1C, 0x54, 0xF5, 0x0D, 0x02, 0x57, 0xFD, 0xA2, 0xC6, 0xD1, 0xCF, 0x71, 0x25, 0x4F, 0x3F, 0x07,
    0xBF, 0x66, 0xF7, 0xF5, 0x13, 0xE7, 0xAD, 0x79, 0xDF, 0x26, 0xEF, 0x26, 0x3A, 0x18, 0x18,
};

uint16_t TestDevice5_OperationalServiceAssignedCertLength = sizeof(TestDevice5_OperationalServiceAssignedCert);

uint8_t TestDevice5_OperationalPrivateKey[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x02, 0x00, 0x26, 0x01, 0x1B, 0x00, 0x5A, 0x23, 0x30, 0x02, 0x20,
    0x75, 0xA5, 0x8D, 0xE1, 0xE4, 0xAF, 0x55, 0xDF, 0x16, 0x77, 0x2A, 0x7F, 0xFB, 0xDD, 0xBF, 0x34,
    0x63, 0xAB, 0x73, 0xE9, 0x13, 0xAE, 0x22, 0x2A, 0x75, 0xB5, 0x1C, 0x29, 0x16, 0xB2, 0xB6, 0xD0,
    0x30, 0x03, 0x41, 0x04, 0x3E, 0xE5, 0xEC, 0xFA, 0xED, 0x68, 0xF1, 0x28, 0xB3, 0xCE, 0xC2, 0x4D,
    0x96, 0x7F, 0x3E, 0xC2, 0xF8, 0x29, 0x23, 0x8E, 0x43, 0xCC, 0xDE, 0x07, 0x96, 0x92, 0xA9, 0x3C,
    0x53, 0x61, 0x2C, 0x33, 0x1D, 0x4B, 0x9B, 0x60, 0x31, 0xE2, 0x5A, 0xA1, 0xF0, 0xF0, 0x90, 0x45,
    0x65, 0xFC, 0xC9, 0x8B, 0xA3, 0x38, 0x2D, 0xA3, 0xD3, 0x56, 0xBF, 0x80, 0x49, 0x97, 0xA0, 0xA1,
    0xAC, 0x97, 0x50, 0x01, 0x18,
};

uint16_t TestDevice5_OperationalPrivateKeyLength = sizeof(TestDevice5_OperationalPrivateKey);


// Operational credentials: node Id, self-signed certificate, service-assigned certificate and private key for Test Device 6
//

uint64_t TestDevice6_OperationalNodeId = 0x1AB4300000000006ULL;

uint8_t TestDevice6_OperationalSelfSignedCert[] =
{
    ,
};

uint16_t TestDevice6_OperationalSelfSignedCertLength = sizeof(TestDevice6_OperationalSelfSignedCert);

uint8_t TestDevice6_OperationalServiceAssignedCert[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x30, 0x01, 0x08, 0x42, 0x77, 0x50, 0xB8, 0x54, 0x96,
    0x61, 0x79, 0x24, 0x02, 0x05, 0x37, 0x03, 0x27, 0x11, 0x02, 0x00, 0x00, 0xFF, 0xEE, 0x30, 0xB4,
    0x18, 0x18, 0x26, 0x04, 0x2A, 0x07, 0x85, 0x25, 0x26, 0x05, 0x2A, 0x53, 0xAD, 0x38, 0x37, 0x06,
    0x27, 0x11, 0x06, 0x00, 0x00, 0x00, 0x00, 0x30, 0xB4, 0x1A, 0x18, 0x24, 0x07, 0x02, 0x26, 0x08,
    0x1B, 0x00, 0x5A, 0x23, 0x30, 0x0A, 0x41, 0x04, 0xD7, 0xE8, 0xD4, 0xCC, 0xA9, 0x59, 0xF6, 0x90,
    0xFF, 0xAF, 0x48, 0x39, 0xB5, 0x66, 0xF4, 0x3C, 0xC0, 0x81, 0x8E, 0x16, 0x9E, 0x2F, 0xDA, 0x14,
    ...
    0x18, 0x35, 0x81, 0x30, 0x02, 0x08, 0x4B, 0xB6, 0x33, 0x5E, 0xA0, 0xF5, 0x45, 0x21, 0x18, 0x35,
    0x80, 0x30, 0x02, 0x08, 0x46, 0xF3, 0xF1, 0xAF, 0xDE, 0x30, 0x78, 0x9F, 0x18, 0x35, 0x0C, 0x30,
    0x01, 0x1C, 0x6B, 0xD4, 0x02, 0xCA, 0x35, 0x53, 0x4D, 0x7D, 0x9D, 0xDA, 0x3D, 0x2A, 0x04, 0xE2,
    0x44, 0x98, 0x70, 0x6D, 0x59, 0x14, 0xFB, 0x40, 0xE2, 0x54, 0x4F, 0xB4, 0xAF, 0x6F, 0x30, 0x02,
    0x1D, 0x00, 0x87, 0x6F, 0x9A, 0x85, 0x63, 0xF5, 0x80, 0x0F, 0x2D, 0xE6, 0xC1, 0x73, 0x5D, 0x8C,
    0x16, 0x42, 0xAA, 0x80, 0x97, 0x10, 0xDD, 0x21, 0xAF, 0xB2, 0x43, 0x64, 0x38, 0x37, 0x18, 0x18,
};

uint16_t TestDevice6_OperationalServiceAssignedCertLength = sizeof(TestDevice6_OperationalServiceAssignedCert);

uint8_t TestDevice6_OperationalPrivateKey[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x02, 0x00, 0x26, 0x01, 0x1B, 0x00, 0x5A, 0x23, 0x30, 0x02, 0x20,
    0x52, 0xB7, 0x7C, 0x3A, 0xDD, 0xF2, 0xF0, 0x99, 0x82, 0xF5, 0x35, 0xED, 0x6C, 0xB7, 0xA2, 0x6B,
    0xB4, 0xED, 0x0E, 0x84, 0xB5, 0x5B, 0x05, 0x33, 0x7E, 0x42, 0x4D, 0x7F, 0xAE, 0x44, 0x28, 0x15,
    0x30, 0x03, 0x41, 0x04, 0xD7, 0xE8, 0xD4, 0xCC, 0xA9, 0x59, 0xF6, 0x90, 0xFF, 0xAF, 0x48, 0x39,
    0xB5, 0x66, 0xF4, 0x3C, 0xC0, 0x81, 0x8E, 0x16, 0x9E, 0x2F, 0xDA, 0x14, 0x79, 0xD4, 0xE5, 0x7C,
    0xC0, 0x00, 0xB3, 0x9A, 0x36, 0x71, 0x95, 0xE0, 0xE0, 0xD8, 0xB1, 0xD0, 0x5B, 0x1F, 0x83, 0x15,
    0x51, 0xA3, 0x68, 0xFC, 0xAF, 0xC0, 0x89, 0xD6, 0x2D, 0xE7, 0x68, 0xA5, 0xA4, 0xDF, 0x3A, 0x8E,
    0x72, 0x7A, 0x15, 0xA8, 0x18,
};

uint16_t TestDevice6_OperationalPrivateKeyLength = sizeof(TestDevice6_OperationalPrivateKey);


// Operational credentials: node Id, self-signed certificate, service-assigned certificate and private key for Test Device 7
//

uint64_t TestDevice7_OperationalNodeId = 0x1AB4300000000007ULL;

uint8_t TestDevice7_OperationalSelfSignedCert[] =
{
    ,
};

uint16_t TestDevice7_OperationalSelfSignedCertLength = sizeof(TestDevice7_OperationalSelfSignedCert);

uint8_t TestDevice7_OperationalServiceAssignedCert[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x30, 0x01, 0x08, 0x63, 0x1A, 0x32, 0x20, 0x03, 0xBE,
    0x10, 0x78, 0x24, 0x02, 0x05, 0x37, 0x03, 0x27, 0x11, 0x02, 0x00, 0x00, 0xFF, 0xEE, 0x30, 0xB4,
    0x18, 0x18, 0x26, 0x04, 0x2A, 0x07, 0x85, 0x25, 0x26, 0x05, 0x2A, 0x53, 0xAD, 0x38, 0x37, 0x06,
    0x27, 0x11, 0x07, 0x00, 0x00, 0x00, 0x00, 0x30, 0xB4, 0x1A, 0x18, 0x24, 0x07, 0x02, 0x26, 0x08,
    0x1B, 0x00, 0x5A, 0x23, 0x30, 0x0A, 0x41, 0x04, 0xFD, 0xA4, 0xE2, 0x40, 0x81, 0x25, 0x1F, 0x4A,
    0x24, 0xE8, 0x1C, 0x8D, 0xE8, 0x66, 0x75, 0x60, 0x5A, 0x65, 0xEE, 0x69, 0x1D, 0xF6, 0x17, 0xFF,
    ...
    0x18, 0x35, 0x81, 0x30, 0x02, 0x08, 0x40, 0x48, 0x6C, 0xDF, 0x5D, 0xA0, 0xAD, 0xBD, 0x18, 0x35,
    0x80, 0x30, 0x02, 0x08, 0x46, 0xF3, 0xF1, 0xAF, 0xDE, 0x30, 0x78, 0x9F, 0x18, 0x35, 0x0C, 0x30,
    0x01, 0x1D, 0x00, 0xD0, 0x30, 0xED, 0xFA, 0x20, 0xC6, 0xF4, 0x32, 0x0C, 0xDC, 0xF9, 0x80, 0x4E,
    0x7C, 0x66, 0x13, 0x16, 0x09, 0x50, 0x08, 0x07, 0x31, 0x02, 0x07, 0xAC, 0xB4, 0xBF, 0xA5, 0x30,
    0x02, 0x1D, 0x00, 0xF0, 0x0A, 0x7C, 0xC0, 0x4A, 0x1E, 0x50, 0x7D, 0x21, 0x17, 0xF7, 0x04, 0x5B,
    0x9B, 0x12, 0x2D, 0x59, 0xFB, 0x1D, 0x70, 0x3A, 0x8A, 0x47, 0x5B, 0xDB, 0x4B, 0x19, 0x02, 0x18,
    0x18,
};

uint16_t TestDevice7_OperationalServiceAssignedCertLength = sizeof(TestDevice7_OperationalServiceAssignedCert);

uint8_t TestDevice7_OperationalPrivateKey[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x02, 0x00, 0x26, 0x01, 0x1B, 0x00, 0x5A, 0x23, 0x30, 0x02, 0x20,
    0xAA, 0xB6, 0x7C, 0xE4, 0xE9, 0x95, 0x7E, 0xFF, 0xDE, 0x22, 0x22, 0xC5, 0x85, 0x1E, 0xA9, 0x8B,
    0xCA, 0xB1, 0xD9, 0x6C, 0xA7, 0x56, 0x3D, 0x57, 0xA3, 0xC2, 0xB7, 0x04, 0x66, 0xB6, 0xB7, 0xE8,
    0x30, 0x03, 0x41, 0x04, 0xFD, 0xA4, 0xE2, 0x40, 0x81, 0x25, 0x1F, 0x4A, 0x24, 0xE8, 0x1C, 0x8D,
    0xE8, 0x66, 0x75, 0x60, 0x5A, 0x65, 0xEE, 0x69, 0x1D, 0xF6, 0x17, 0xFF, 0x41, 0x9B, 0x8A, 0xA8,
    0x01, 0x09, 0x8B, 0xFC, 0xB6, 0x67, 0x95, 0xE0, 0x47, 0x28, 0x50, 0x4E, 0x62, 0x95, 0x9E, 0x42,
    0x5E, 0x1D, 0x62, 0xA9, 0x4F, 0xF3, 0x99, 0x83, 0xCB, 0x3C, 0xDB, 0xE4, 0xB1, 0xA3, 0x39, 0x30,
    0x9C, 0x91, 0x52, 0xBC, 0x18,
};

uint16_t TestDevice7_OperationalPrivateKeyLength = sizeof(TestDevice7_OperationalPrivateKey);


// Operational credentials: node Id, self-signed certificate, service-assigned certificate and private key for Test Device 8
//

uint64_t TestDevice8_OperationalNodeId = 0x1AB4300000000008ULL;

uint8_t TestDevice8_OperationalSelfSignedCert[] =
{
    ,
};

uint16_t TestDevice8_OperationalSelfSignedCertLength = sizeof(TestDevice8_OperationalSelfSignedCert);

uint8_t TestDevice8_OperationalServiceAssignedCert[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x30, 0x01, 0x08, 0x56, 0x7E, 0x95, 0x66, 0x28, 0x8D,
    0x1C, 0x44, 0x24, 0x02, 0x05, 0x37, 0x03, 0x27, 0x11, 0x02, 0x00, 0x00, 0xFF, 0xEE, 0x30, 0xB4,
    0x18, 0x18, 0x26, 0x04, 0x2A, 0x07, 0x85, 0x25, 0x26, 0x05, 0x2A, 0x53, 0xAD, 0x38, 0x37, 0x06,
    0x27, 0x11, 0x08, 0x00, 0x00, 0x00, 0x00, 0x30, 0xB4, 0x1A, 0x18, 0x24, 0x07, 0x02, 0x26, 0x08,
    0x1B, 0x00, 0x5A, 0x23, 0x30, 0x0A, 0x41, 0x04, 0x1C, 0x34, 0x9B, 0xC9, 0xC7, 0xD4, 0x51, 0xF1,
    0xF6, 0xC1, 0x8C, 0xAA, 0x2E, 0xEA, 0x1F, 0x1A, 0xE5, 0x13, 0x29, 0xF9, 0x6B, 0xA6, 0x6A, 0x26,
    ...
    0x18, 0x35, 0x81, 0x30, 0x02, 0x08, 0x4E, 0x33, 0x78, 0x53, 0x6F, 0x7E, 0x1B, 0xA9, 0x18, 0x35,
    0x80, 0x30, 0x02, 0x08, 0x46, 0xF3, 0xF1, 0xAF, 0xDE, 0x30, 0x78, 0x9F, 0x18, 0x35, 0x0C, 0x30,
    0x01, 0x1D, 0x00, 0xB9, 0x95, 0x3C, 0xA5, 0xAF, 0x66, 0x59, 0xFC, 0x9D, 0x82, 0xD3, 0xF6, 0xA0,
    0x6B, 0x2D, 0xEC, 0x80, 0x6E, 0x0F, 0x9A, 0x3B, 0xEF, 0x6E, 0x72, 0xC6, 0x26, 0x7E, 0xDA, 0x30,
    0x02, 0x1C, 0x18, 0x75, 0x7B, 0x47, 0x57, 0xF2, 0x64, 0xCD, 0xC3, 0xC9, 0x1C, 0xB7, 0xE3, 0x55,
    0xD8, 0xDC, 0x20, 0x52, 0x00, 0x94, 0x95, 0xD1, 0x65, 0xCC, 0xAF, 0x10, 0xF0, 0x92, 0x18, 0x18,
};

uint16_t TestDevice8_OperationalServiceAssignedCertLength = sizeof(TestDevice8_OperationalServiceAssignedCert);

uint8_t TestDevice8_OperationalPrivateKey[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x02, 0x00, 0x26, 0x01, 0x1B, 0x00, 0x5A, 0x23, 0x30, 0x02, 0x20,
    0xA3, 0x99, 0x99, 0xAD, 0x43, 0x71, 0xD0, 0x57, 0xD5, 0xAF, 0xF1, 0xBE, 0xF9, 0x67, 0xAD, 0xED,
    0xA6, 0xDB, 0x2C, 0xC0, 0x47, 0xE6, 0x4A, 0x6D, 0x8D, 0x38, 0x86, 0x30, 0xCF, 0x7A, 0x1D, 0x98,
    0x30, 0x03, 0x41, 0x04, 0x1C, 0x34, 0x9B, 0xC9, 0xC7, 0xD4, 0x51, 0xF1, 0xF6, 0xC1, 0x8C, 0xAA,
    0x2E, 0xEA, 0x1F, 0x1A, 0xE5, 0x13, 0x29, 0xF9, 0x6B, 0xA6, 0x6A, 0x26, 0x68, 0x67, 0x0B, 0x3E,
    0x9E, 0x32, 0x52, 0x62, 0xC0, 0x25, 0xE6, 0x82, 0x9C, 0x8A, 0x05, 0x55, 0x24, 0x9A, 0x5D, 0xEC,
    0xBD, 0xB7, 0x3D, 0xCE, 0x11, 0xB0, 0x22, 0xA8, 0xCF, 0x96, 0xF8, 0xAD, 0x7F, 0xAF, 0xC9, 0x6F,
    0xB3, 0x00, 0x5F, 0x78, 0x18,
};

uint16_t TestDevice8_OperationalPrivateKeyLength = sizeof(TestDevice8_OperationalPrivateKey);


// Operational credentials: node Id, self-signed certificate, service-assigned certificate and private key for Test Device 9
//

uint64_t TestDevice9_OperationalNodeId = 0x1AB4300000000009ULL;

uint8_t TestDevice9_OperationalSelfSignedCert[] =
{
    ,
};

uint16_t TestDevice9_OperationalSelfSignedCertLength = sizeof(TestDevice9_OperationalSelfSignedCert);

uint8_t TestDevice9_OperationalServiceAssignedCert[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x30, 0x01, 0x08, 0x5B, 0x85, 0x86, 0xED, 0xFA, 0x54,
    0xD0, 0x9A, 0x24, 0x02, 0x05, 0x37, 0x03, 0x27, 0x11, 0x02, 0x00, 0x00, 0xFF, 0xEE, 0x30, 0xB4,
    0x18, 0x18, 0x26, 0x04, 0x2A, 0x07, 0x85, 0x25, 0x26, 0x05, 0x2A, 0x53, 0xAD, 0x38, 0x37, 0x06,
    0x27, 0x11, 0x09, 0x00, 0x00, 0x00, 0x00, 0x30, 0xB4, 0x1A, 0x18, 0x24, 0x07, 0x02, 0x26, 0x08,
    0x1B, 0x00, 0x5A, 0x23, 0x30, 0x0A, 0x41, 0x04, 0x65, 0x4A, 0x97, 0x47, 0xD2, 0xF7, 0xBB, 0xFE,
    0x8B, 0x03, 0xB3, 0xE5, 0x4C, 0x44, 0x40, 0xB8, 0x59, 0x8A, 0x11, 0x04, 0xF4, 0x66, 0xE6, 0x37,
    ...
    0x18, 0x35, 0x81, 0x30, 0x02, 0x08, 0x46, 0x70, 0xA0, 0xAD, 0x26, 0xB0, 0x3C, 0x96, 0x18, 0x35,
    0x80, 0x30, 0x02, 0x08, 0x46, 0xF3, 0xF1, 0xAF, 0xDE, 0x30, 0x78, 0x9F, 0x18, 0x35, 0x0C, 0x30,
    0x01, 0x1D, 0x00, 0xA7, 0xE1, 0x6B, 0x25, 0x65, 0x1B, 0xCE, 0xD3, 0x04, 0x17, 0x1F, 0xC9, 0x93,
    0x34, 0x4E, 0x0E, 0xD3, 0xC7, 0xEB, 0x70, 0x71, 0x63, 0x47, 0x2D, 0xA7, 0x32, 0x8E, 0x24, 0x30,
    0x02, 0x1D, 0x00, 0xBB, 0xEF, 0x26, 0x75, 0xCE, 0xB4, 0xBF, 0xAA, 0xD7, 0x33, 0x16, 0x90, 0xDE,
    0xDA, 0x32, 0x51, 0xF6, 0x24, 0xF0, 0x14, 0xDF, 0x8D, 0xF2, 0x60, 0x15, 0x6A, 0x51, 0xE5, 0x18,
    0x18,
};

uint16_t TestDevice9_OperationalServiceAssignedCertLength = sizeof(TestDevice9_OperationalServiceAssignedCert);

uint8_t TestDevice9_OperationalPrivateKey[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x02, 0x00, 0x26, 0x01, 0x1B, 0x00, 0x5A, 0x23, 0x30, 0x02, 0x20,
    0xA1, 0xFA, 0xA3, 0xE9, 0x71, 0xDE, 0xD4, 0xCE, 0xC1, 0xF7, 0xE0, 0x8F, 0x53, 0xD0, 0x45, 0xDD,
    0xB5, 0xB2, 0xD2, 0x12, 0x8B, 0x1A, 0x77, 0x02, 0x23, 0x0A, 0x20, 0x31, 0xAC, 0x97, 0xCB, 0x88,
    0x30, 0x03, 0x41, 0x04, 0x65, 0x4A, 0x97, 0x47, 0xD2, 0xF7, 0xBB, 0xFE, 0x8B, 0x03, 0xB3, 0xE5,
    0x4C, 0x44, 0x40, 0xB8, 0x59, 0x8A, 0x11, 0x04, 0xF4, 0x66, 0xE6, 0x37, 0x9C, 0x2A, 0xDE, 0xE1,
    0x19, 0x20, 0xE3, 0x83, 0xB0, 0xAD, 0x0C, 0xA2, 0xE2, 0x44, 0x14, 0x88, 0xBA, 0x89, 0xE3, 0x56,
    0xF7, 0x99, 0x1A, 0x96, 0x5E, 0x5E, 0xFF, 0x27, 0x06, 0x18, 0xE9, 0xCB, 0xFC, 0x86, 0xEE, 0xAF,
    0x5F, 0x21, 0xDB, 0xA0, 0x18,
};

uint16_t TestDevice9_OperationalPrivateKeyLength = sizeof(TestDevice9_OperationalPrivateKey);


// Operational credentials: node Id, self-signed certificate, service-assigned certificate and private key for Test Device 10
//

uint64_t TestDevice10_OperationalNodeId = 0x1AB430000000000AULL;

uint8_t TestDevice10_OperationalSelfSignedCert[] =
{
    ,
};

uint16_t TestDevice10_OperationalSelfSignedCertLength = sizeof(TestDevice10_OperationalSelfSignedCert);

uint8_t TestDevice10_OperationalServiceAssignedCert[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x01, 0x00, 0x30, 0x01, 0x08, 0x69, 0xEB, 0xF0, 0x2B, 0xBC, 0xA0,
    0x2F, 0x62, 0x24, 0x02, 0x05, 0x37, 0x03, 0x27, 0x11, 0x02, 0x00, 0x00, 0xFF, 0xEE, 0x30, 0xB4,
    0x18, 0x18, 0x26, 0x04, 0x2A, 0x07, 0x85, 0x25, 0x26, 0x05, 0x2A, 0x53, 0xAD, 0x38, 0x37, 0x06,
    0x27, 0x11, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x30, 0xB4, 0x1A, 0x18, 0x24, 0x07, 0x02, 0x26, 0x08,
    0x1B, 0x00, 0x5A, 0x23, 0x30, 0x0A, 0x41, 0x04, 0xDA, 0x88, 0x11, 0x59, 0xFD, 0x96, 0xB0, 0xE4,
    0x9B, 0xC1, 0xB7, 0x71, 0xE6, 0x9F, 0x91, 0x99, 0x78, 0xE4, 0x42, 0x86, 0x6C, 0xF5, 0x5D, 0x4F,
    ...
    0x18, 0x35, 0x81, 0x30, 0x02, 0x08, 0x47, 0xD9, 0xA8, 0x1B, 0x62, 0x6A, 0x65, 0x5D, 0x18, 0x35,
    0x80, 0x30, 0x02, 0x08, 0x46, 0xF3, 0xF1, 0xAF, 0xDE, 0x30, 0x78, 0x9F, 0x18, 0x35, 0x0C, 0x30,
    0x01, 0x1C, 0x43, 0x9A, 0x77, 0xFA, 0x3A, 0xF9, 0x81, 0x1B, 0x4C, 0xFC, 0x28, 0xD7, 0x40, 0xE4,
    0xD0, 0x20, 0xE6, 0x87, 0x75, 0x1E, 0xCF, 0x81, 0x41, 0x35, 0xCF, 0x09, 0x00, 0x7C, 0x30, 0x02,
    0x1C, 0x79, 0x3A, 0x45, 0x2D, 0x34, 0xEC, 0x46, 0x4C, 0x27, 0xE9, 0x08, 0x42, 0xCF, 0x6B, 0x99,
    0x4F, 0xC4, 0xFF, 0xEB, 0x57, 0xAB, 0x30, 0xF5, 0xA1, 0x15, 0x09, 0xDC, 0x43, 0x18, 0x18,
};

uint16_t TestDevice10_OperationalServiceAssignedCertLength = sizeof(TestDevice10_OperationalServiceAssignedCert);

uint8_t TestDevice10_OperationalPrivateKey[] =
{
    0xD5, 0x00, 0x00, 0x04, 0x00, 0x02, 0x00, 0x26, 0x01, 0x1B, 0x00, 0x5A, 0x23, 0x30, 0x02, 0x20,
    0xC6, 0x4B, 0xAB, 0xF0, 0x2B, 0xC8, 0x3E, 0xBC, 0xED, 0xED, 0xB4, 0x44, 0x46, 0xEF, 0x78, 0xDD,
    0x85, 0x39, 0x2F, 0xA9, 0x88, 0x90, 0xEA, 0x61, 0xC6, 0xFE, 0x5B, 0x09, 0x15, 0xE9, 0x4D, 0x2C,
    0x30, 0x03, 0x41, 0x04, 0xDA, 0x88, 0x11, 0x59, 0xFD, 0x96, 0xB0, 0xE4, 0x9B, 0xC1, 0xB7, 0x71,
    0xE6, 0x9F, 0x91, 0x99, 0x78, 0xE4, 0x42, 0x86, 0x6C, 0xF5, 0x5D, 0x4F, 0x67, 0x6A, 0x04, 0xA2,
    0xF1, 0xA0, 0xE8, 0x6A, 0x2D, 0xC6, 0x2E, 0xA5, 0x1F, 0x62, 0x37, 0x23, 0xB8, 0x93, 0x5E, 0xE8,
    0xA6, 0x2A, 0xED, 0xDC, 0x1E, 0xB3, 0x7D, 0xED, 0x09, 0x49, 0x65, 0x93, 0xFB, 0x82, 0xF7, 0xB5,
    0x67, 0x48, 0x7F, 0x8A, 0x18,
};
...
TestNodeOperationalCred TestNodeOperationalCredentials[] =
{
    { TestDevice1_OperationalNodeId, TestDevice1_OperationalSelfSignedCert, TestDevice1_OperationalSelfSignedCertLength,
      TestDevice1_OperationalSelfSignedCert, TestDevice1_OperationalSelfSignedCertLength, TestDevice1_OperationalPrivateKey, TestDevice1_OperationalPrivateKeyLength },
    { TestDevice2_OperationalNodeId, TestDevice2_OperationalSelfSignedCert, TestDevice2_OperationalSelfSignedCertLength,
      TestDevice2_OperationalSelfSignedCert, TestDevice2_OperationalSelfSignedCertLength, TestDevice2_OperationalPrivateKey, TestDevice2_OperationalPrivateKeyLength },
    { TestDevice3_OperationalNodeId, TestDevice3_OperationalSelfSignedCert, TestDevice3_OperationalSelfSignedCertLength,
      TestDevice3_OperationalSelfSignedCert, TestDevice3_OperationalSelfSignedCertLength, TestDevice3_OperationalPrivateKey, TestDevice3_OperationalPrivateKeyLength },
    { TestDevice4_OperationalNodeId, TestDevice4_OperationalSelfSignedCert, TestDevice4_OperationalSelfSignedCertLength,
      TestDevice4_OperationalSelfSignedCert, TestDevice4_OperationalSelfSignedCertLength, TestDevice4_OperationalPrivateKey, TestDevice4_OperationalPrivateKeyLength },
    { TestDevice5_OperationalNodeId, TestDevice5_OperationalSelfSignedCert, TestDevice5_OperationalSelfSignedCertLength,
      TestDevice5_OperationalSelfSignedCert, TestDevice5_OperationalSelfSignedCertLength, TestDevice5_OperationalPrivateKey, TestDevice5_OperationalPrivateKeyLength },
    { TestDevice6_OperationalNodeId, TestDevice6_OperationalSelfSignedCert, TestDevice6_OperationalSelfSignedCertLength,
      TestDevice6_OperationalSelfSignedCert, TestDevice6_OperationalSelfSignedCertLength, TestDevice6_OperationalPrivateKey, TestDevice6_OperationalPrivateKeyLength },
    { TestDevice7_OperationalNodeId, TestDevice7_OperationalSelfSignedCert, TestDevice7_OperationalSelfSignedCertLength,
      TestDevice7_OperationalSelfSignedCert, TestDevice7_OperationalSelfSignedCertLength, TestDevice7_OperationalPrivateKey, TestDevice7_OperationalPrivateKeyLength },
    { TestDevice8_OperationalNodeId, TestDevice8_OperationalSelfSignedCert, TestDevice8_OperationalSelfSignedCertLength,
      TestDevice8_OperationalSelfSignedCert, TestDevice8_OperationalSelfSignedCertLength, TestDevice8_OperationalPrivateKey, TestDevice8_OperationalPrivateKeyLength },
    { TestDevice9_OperationalNodeId, TestDevice9_OperationalSelfSignedCert, TestDevice9_OperationalSelfSignedCertLength,
      TestDevice9_OperationalSelfSignedCert, TestDevice9_OperationalSelfSignedCertLength, TestDevice9_OperationalPrivateKey, TestDevice9_OperationalPrivateKeyLength },
    { TestDevice10_OperationalNodeId, TestDevice10_OperationalSelfSignedCert, TestDevice10_OperationalSelfSignedCertLength,
      TestDevice10_OperationalSelfSignedCert, TestDevice10_OperationalSelfSignedCertLength, TestDevice10_OperationalPrivateKey, TestDevice10_OperationalPrivateKeyLength },
    { 0, NULL, 0, NULL, 0 }
};
...
bool GetTestOperationalSelfSignedNodeCert(uint64_t nodeId, const uint8_t *& cert, uint16_t& certLen)
{
    for (TestNodeOperationalCred *p = TestNodeOperationalCredentials; p->NodeId != 0; p++)
        if (p->NodeId == nodeId)
        {
            cert = p->SelfSignedCert;
            certLen = p->SelfSignedCertLength;
            return true;
        }
    return false;
}

bool GetTestOperationalServiceAssignedNodeCert(uint64_t nodeId, const uint8_t *& cert, uint16_t& certLen)
{
    for (TestNodeOperationalCred *p = TestNodeOperationalCredentials; p->NodeId != 0; p++)
        if (p->NodeId == nodeId)
        {
            cert = p->ServiceAssignedCert;
            certLen = p->ServiceAssignedCertLength;
            return true;
        }
    return false;
}

bool GetTestOperationalNodePrivateKey(uint64_t nodeId, const uint8_t *& key, uint16_t& keyLen)
{
    for (TestNodeOperationalCred *p = TestNodeOperationalCredentials; p->NodeId != 0; p++)
        if (p->NodeId == nodeId)
        {
...
bool GetTestNodeManufAttestCert(uint64_t nodeId, const uint8_t *& cert, uint16_t& certLen)
{
    return GetTestNodeCert(nodeId ^ kEUI64_UL_Mask, cert, certLen);
}

bool GetTestNodeManufAttestPrivateKey(uint64_t nodeId, const uint8_t *& key, uint16_t& keyLen)
{
    return GetTestNodePrivateKey(nodeId ^ kEUI64_UL_Mask, key, keyLen);
}
