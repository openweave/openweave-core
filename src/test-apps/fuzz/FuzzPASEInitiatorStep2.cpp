...
/**
 *    @file
 *      This file implements a process to fuzz InitiatorStep2 of
...
{
    if (size > 0) {
        MessageExternalFuzzer fuzzer = MessageExternalFuzzer(INITIATOR_STEP_2)
            .FuzzInput(data, size);
        ...
        PASEEngineTest(testName)
                ...
                .ExpectError(INITIATOR_STEP_2, WEAVE_ERROR_INVALID_PASE_PARAMETER)
                .ExpectError(INITIATOR_STEP_2, WEAVE_ERROR_INVALID_MESSAGE_LENGTH)
                .ExpectError(INITIATOR_STEP_2, WEAVE_ERROR_INVALID_ARGUMENT)
                .ExpectError(INITIATOR_STEP_2, WEAVE_ERROR_MESSAGE_INCOMPLETE)
                .ExpectError(INITIATOR_STEP_2, WEAVE_ERROR_NO_MEMORY)
                .Run();
    }
    return 0;
}
