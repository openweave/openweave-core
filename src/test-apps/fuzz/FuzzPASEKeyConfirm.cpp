...
/**
 *    @file
 *      This file implements a process to fuzz the key confirmation of
...
{
    if (size > 0) {
        MessageExternalFuzzer fuzzer = MessageExternalFuzzer(RESPONDER_KEY_CONFIRM)
            .FuzzInput(data, size);
        ...
        PASEEngineTest(testName)
                ...
                .ExpectError(RESPONDER_KEY_CONFIRM, WEAVE_ERROR_INVALID_PASE_PARAMETER)
                .ExpectError(RESPONDER_KEY_CONFIRM, WEAVE_ERROR_INVALID_MESSAGE_LENGTH)
                .ExpectError(RESPONDER_KEY_CONFIRM, WEAVE_ERROR_INVALID_ARGUMENT)
                .ExpectError(RESPONDER_KEY_CONFIRM, WEAVE_ERROR_MESSAGE_INCOMPLETE)
                .ExpectError(RESPONDER_KEY_CONFIRM, WEAVE_ERROR_NO_MEMORY)
                .ExpectError(RESPONDER_KEY_CONFIRM, WEAVE_ERROR_KEY_CONFIRMATION_FAILED)
                .Run();
    }
    return 0;
}
