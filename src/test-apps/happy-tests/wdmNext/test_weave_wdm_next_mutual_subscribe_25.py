...
class test_weave_wdm_next_mutual_subscribe_25(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_25(self):
        wdm_next_args = {}
        ...
        wdm_next_args['final_server_status'] = 0
