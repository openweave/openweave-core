...
class test_weave_wdm_next_mutual_subscribe_27(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_27(self):
        wdm_next_args = {}
        ...
        wdm_next_args['final_server_status'] = 2
