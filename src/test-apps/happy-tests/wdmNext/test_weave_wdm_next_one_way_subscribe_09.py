...
class test_weave_wdm_next_one_way_subscribe_09(weave_wdm_next_test_base):

    def test_weave_wdm_next_one_way_subscribe_09(self):
        wdm_next_args = {}
        ...
        wdm_next_args['final_server_status'] = 1
        wdm_next_args['timer_server_period'] = 10000
