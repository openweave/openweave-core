...
try:
    ...
    print ("Failed to import WeaveDataManagementClient: %s" % (str(ex)))
...
def testWDMClientDataSinkRefreshIndividualData(testObject):
    ...
    testObject.closeWdmClient()
    print "testWDMClientDataSinkRefreshIndividualData completes"
...
def RunWDMClientTest():
    ...
    testWDMClientDataSinkRefreshData(testObject)
    testWDMClientDataSinkRefreshIndividualData(testObject)
