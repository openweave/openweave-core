...
#       I08: Mutual Subscribe: Responder Continuous Events. Mutate data in responder. Publisher in initiator aborts
...
class test_weave_wdm_next_mutual_subscribe_51(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_51(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test I08 and M32"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_mutual_subscribe_51,
