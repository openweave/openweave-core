...
#       I16: Mutual Subscribe: Responder Continuous Events. Publisher in initiator aborts
...
class test_weave_wdm_next_mutual_subscribe_59(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_59(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test I16 and M40"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_mutual_subscribe_59,
