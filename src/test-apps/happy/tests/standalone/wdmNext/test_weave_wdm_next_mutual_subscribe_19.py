...
#       F15: Mutual Subscribe: Root path. Null Version. Mutate data in initiator and responder. Client in initiator aborts
...
class test_weave_wdm_next_mutual_subscribe_19(weave_wdm_next_test_base):
    ...
    def test_weave_wdm_next_mutual_subscribe_19(self):
        ...
        super(test_weave_wdm_next_mutual_subscribe_19,
