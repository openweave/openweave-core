...
class test_weave_wdm_next_one_way_subscribe_10(weave_wdm_next_test_base):

    def test_weave_wdm_next_one_way_subscribe_10(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test C06"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_one_way_subscribe_10,
