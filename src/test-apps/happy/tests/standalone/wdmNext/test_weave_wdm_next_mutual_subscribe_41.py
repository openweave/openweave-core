...
class test_weave_wdm_next_mutual_subscribe_41(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_41(self):
        wdm_next_args = {}
        ...
        wdm_next_args['client_log_check'] = [('Handler\[0\] \[(ALIVE|CONFM)\] bound mutual subscription is going away', wdm_next_args['test_client_iterations']),
                                             ...
                                             ('Client\[0\] moving to \[ FREE\] Ref\(0\)', 1),
        ...
        wdm_next_args['server_log_check'] = [('Client->kEvent_OnNotificationProcessed', 1),
