...
#       H01: One way Subscribe: Publisher Continuous Events. Publisher mutates trait data. Client cancels
...
class test_weave_wdm_next_one_way_subscribe_14(weave_wdm_next_test_base):

    def test_weave_wdm_next_one_way_subscribe_14(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test H01 and L07"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_one_way_subscribe_14,
