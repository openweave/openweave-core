...
#       F12: Mutual Subscribe: Root path. Null Version. Mutate data in responder. Publisher in initiator aborts
...
class test_weave_wdm_next_mutual_subscribe_16(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_16(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test F12 and M16"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_mutual_subscribe_16,
