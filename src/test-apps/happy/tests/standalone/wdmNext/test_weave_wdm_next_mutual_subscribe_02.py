...
#       E02: Mutual Subscribe: Root path. Null Version. Publisher in initiator cancels
...
class test_weave_wdm_next_mutual_subscribe_02(weave_wdm_next_test_base):
    ...
    def test_weave_wdm_next_mutual_subscribe_02(self):
        ...
        super(test_weave_wdm_next_mutual_subscribe_02,
