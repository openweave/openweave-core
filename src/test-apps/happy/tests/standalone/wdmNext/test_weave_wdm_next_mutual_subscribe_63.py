...
#       I20: Mutual Subscribe: Initiator and Responder Continuous Events. Mutate data in initiator and responder. Publisher in initiator aborts
...
class test_weave_wdm_next_mutual_subscribe_63(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_63(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test I20 and M44"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_mutual_subscribe_63,
