...
#       F10: Mutual Subscribe: Root path. Null Version. Mutate data in responder. Publisher in initiator cancels
...
class test_weave_wdm_next_mutual_subscribe_14(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_14(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test F10 and M14"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_mutual_subscribe_14,
