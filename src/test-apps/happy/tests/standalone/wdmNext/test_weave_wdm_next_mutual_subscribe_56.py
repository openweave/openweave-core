...
#       I13: Mutual Subscribe: Responder Continuous Events. Client in initiator cancels
...
class test_weave_wdm_next_mutual_subscribe_56(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_56(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test I13 and M37"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_mutual_subscribe_56,
