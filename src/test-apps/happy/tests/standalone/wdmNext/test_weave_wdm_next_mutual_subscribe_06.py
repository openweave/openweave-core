...
#       F02: Mutual Subscribe: Root path. Null Version. Idle. Publisher in initiator cancels
...
class test_weave_wdm_next_mutual_subscribe_06(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_06(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test F02 and M06"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_mutual_subscribe_06,
