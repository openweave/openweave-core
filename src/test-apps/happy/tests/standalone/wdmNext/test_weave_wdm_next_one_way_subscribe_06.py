...
#       C04: One way Subscribe: Root path. Null Version. Mutate data in Publisher. Client aborts
...
class test_weave_wdm_next_one_way_subscribe_06(weave_wdm_next_test_base):

    def test_weave_wdm_next_one_way_subscribe_06(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test C04 and L06"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_one_way_subscribe_06,
