...
#       I19: Mutual Subscribe: Initiator and Responder Continuous Events. Mutate data in initiator and responder. Client in initiator aborts
...
class test_weave_wdm_next_mutual_subscribe_62(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_62(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test I19 and M43"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_mutual_subscribe_62,
