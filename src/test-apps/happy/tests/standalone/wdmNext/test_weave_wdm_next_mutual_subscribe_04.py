...
#       E04: Mutual Subscribe: Root path. Null Version. Publisher in initiator aborts
...
class test_weave_wdm_next_mutual_subscribe_04(weave_wdm_next_test_base):
    ...
    def test_weave_wdm_next_mutual_subscribe_04(self):
        ...
        super(test_weave_wdm_next_mutual_subscribe_04,
