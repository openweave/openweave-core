...
class test_weave_wdm_next_mutual_subscribe_31(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_31(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test F23"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_mutual_subscribe_31,
