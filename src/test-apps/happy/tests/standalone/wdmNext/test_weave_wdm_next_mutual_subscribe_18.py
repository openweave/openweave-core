...
#       F14: Mutual Subscribe: Root path. Null Version. Mutate data in initiator and responder, Publisher in initiator cancels
...
class test_weave_wdm_next_mutual_subscribe_18(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_18(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test F14 and M18"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_mutual_subscribe_18,
