...
#       I10: Mutual Subscribe: Initiator Continuous Events. Publisher in initiator cancels
...
class test_weave_wdm_next_mutual_subscribe_53(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_53(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test I10 and M34"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_mutual_subscribe_53,
