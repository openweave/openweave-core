...
#       F11: Mutual Subscribe: Root path. Null Version. Mutate data in responder. Client in initiator aborts
...
class test_weave_wdm_next_mutual_subscribe_15(weave_wdm_next_test_base):

    def test_weave_wdm_next_mutual_subscribe_15(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test F11 and M15"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_mutual_subscribe_15,
