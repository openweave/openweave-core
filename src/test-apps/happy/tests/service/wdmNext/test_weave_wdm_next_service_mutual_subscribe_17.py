...
#       I01: Mutual Subscribe: Initiator Continuous Events. Mutate data in initiator. Client in initiator cancels
...
class test_weave_wdm_next_service_mutual_subscribe_17(weave_wdm_next_test_service_base):

    def test_weave_wdm_next_service_mutual_subscribe_17(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test I01 and M25"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_service_mutual_subscribe_17,
