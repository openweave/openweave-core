...
class test_weave_wdm_next_service_update_cond_BackToBack(weave_wdm_next_test_service_base):
    def test_weave_wdm_next_service_update_cond_BackToBack(self):
        wdm_next_args = {}
        ...
        wdm_next_args['client_update_num_repeated_mutations'] = 2
        ...
        super(test_weave_wdm_next_service_update_cond_BackToBack, self).weave_wdm_next_test_service_base(wdm_next_args)
