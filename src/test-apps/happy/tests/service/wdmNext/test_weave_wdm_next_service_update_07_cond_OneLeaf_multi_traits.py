...
class test_weave_wdm_next_service_update_06_cond_OneLeaf_multi_traits(weave_wdm_next_test_service_base):
    def test_weave_wdm_next_service_update_06_cond_OneLeaf_multi_traits(self):
        wdm_next_args = {}
        ...
        super(test_weave_wdm_next_service_update_06_cond_OneLeaf_multi_traits, self).weave_wdm_next_test_service_base(wdm_next_args)
