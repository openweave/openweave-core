...
class test_weave_wdm_next_service_update_03_uncond_OneLeaf(weave_wdm_next_test_service_base):

    def test_weave_wdm_next_service_update_03_uncond_OneLeaf(self):
        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test O03"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_service_update_03_uncond_OneLeaf,
