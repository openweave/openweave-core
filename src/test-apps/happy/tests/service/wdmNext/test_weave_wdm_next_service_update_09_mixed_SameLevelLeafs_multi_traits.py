...
class test_weave_wdm_next_service_update_09_mixed_SameLevelLeaves_multi_traits(
    ...
    def test_weave_wdm_next_service_update_09_mixed_SameLevelLeaves_multi_traits(self):
        ...
        super(test_weave_wdm_next_service_update_09_mixed_SameLevelLeaves_multi_traits,
