...
#       I02: Mutual Subscribe: Root path. Initiator Continuous Events. Publisher in initiator cancels
...
class test_weave_wdm_next_service_mutual_subscribe_18(weave_wdm_next_test_service_base):

    def test_weave_wdm_next_service_mutual_subscribe_18(self):

        print 'test file: ' + self.__class__.__name__
        print "weave-wdm-next test I02 and M26"
        wdm_next_args = self.get_test_param_json(self.__class__.__name__)
        super(test_weave_wdm_next_service_mutual_subscribe_18,
