 ...
 *
 */
#ifndef _NEST_TEST_TRAIT__TEST_COMMON_C_H_
#define _NEST_TEST_TRAIT__TEST_COMMON_C_H_
    ...
    } schema_nest_test_test_common_common_enum_a_t;
    // CommonEnumE
    typedef enum
    {
    ...
    } schema_nest_test_test_common_common_enum_e_t;




#endif // _NEST_TEST_TRAIT__TEST_COMMON_C_H_
