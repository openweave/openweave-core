 ...
 *
 */
#ifndef _WEAVE_TRAIT_POWER__BATTERY_POWER_SOURCE_CAPABILITIES_TRAIT_C_H_
#define _WEAVE_TRAIT_POWER__BATTERY_POWER_SOURCE_CAPABILITIES_TRAIT_C_H_
    ...
    } schema_weave_power_battery_power_source_capabilities_trait_battery_chemistry_t;
    ...
    } schema_weave_power_battery_power_source_capabilities_trait_battery_replaceability_t;
    // CommonBatteryDesignationIdentifier
    typedef enum
    {
    ...
    } schema_weave_power_battery_power_source_capabilities_trait_common_battery_designation_identifier_t;
    // ANSIBatteryDesignationIdentifier
    typedef enum
    {
    ...
    } schema_weave_power_battery_power_source_capabilities_trait_ansi_battery_designation_identifier_t;
    // IECBatteryDesignationIdentifier
    typedef enum
    {
    ...
    } schema_weave_power_battery_power_source_capabilities_trait_iec_battery_designation_identifier_t;




#endif // _WEAVE_TRAIT_POWER__BATTERY_POWER_SOURCE_CAPABILITIES_TRAIT_C_H_
