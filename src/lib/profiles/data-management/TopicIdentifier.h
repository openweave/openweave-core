 ...
 */
#ifndef _WEAVE_DATA_MANAGEMENT_TOPIC_IDENTIFIER_H
#define _WEAVE_DATA_MANAGEMENT_TOPIC_IDENTIFIER_H
...
#include <Weave/Profiles/data-management/Legacy/TopicIdentifier.h>
#else
...
#endif // _WEAVE_DATA_MANAGEMENT_TOPIC_IDENTIFIER_H
