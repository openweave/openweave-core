 ...
 */
#ifndef _WEAVE_DATA_MANAGEMENT_CLIENT_DATA_MANAGER_H
#define _WEAVE_DATA_MANAGEMENT_CLIENT_DATA_MANAGER_H
...
#include <Weave/Profiles/data-management/Legacy/ClientDataManager.h>
#else
...
#endif // _WEAVE_DATA_MANAGEMENT_CLIENT_DATA_MANAGER_H
