 ...
 */
#ifndef _WEAVE_DATA_MANAGEMENT_CLIENT_NOTIFIER_H
#define _WEAVE_DATA_MANAGEMENT_CLIENT_NOTIFIER_H
...
#include <Weave/Profiles/data-management/Legacy/ClientNotifier.h>
#else
...
#endif // _WEAVE_DATA_MANAGEMENT_CLIENT_NOTIFIER_H
