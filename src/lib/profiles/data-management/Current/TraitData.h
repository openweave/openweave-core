...
public:
    ...
    WEAVE_ERROR StoreDataElement(PropertyPathHandle aHandle, TLV::TLVReader & aReader, uint8_t aFlags, void * aContext, TraitDataHandle aDatahandle, uint64_t aPreviousFirstSameTraitVersion);
