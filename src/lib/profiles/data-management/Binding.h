 ...
 */
#ifndef _WEAVE_DATA_MANAGEMENT_BINDING_H
#define _WEAVE_DATA_MANAGEMENT_BINDING_H
...
#include <Weave/Profiles/data-management/Legacy/Binding.h>
#else
...
#endif // _WEAVE_DATA_MANAGEMENT_BINDING_H
