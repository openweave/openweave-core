 ...
 */
#ifndef _WEAVE_DATA_MANAGEMENT_DM_CLIENT_H
#define _WEAVE_DATA_MANAGEMENT_DM_CLIENT_H
...
#include <Weave/Profiles/data-management/Legacy/DMClient.h>
#else
...
#endif // _WEAVE_DATA_MANAGEMENT_DM_CLIENT_H
