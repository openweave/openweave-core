 ...
 */
#ifndef _WEAVE_DATA_MANAGEMENT_DM_PUBLISHER_H
#define _WEAVE_DATA_MANAGEMENT_DM_PUBLISHER_H
...
#include <Weave/Profiles/data-management/Legacy/DMPublisher.h>
#else
...
#endif // _WEAVE_DATA_MANAGEMENT_DM_PUBLISHER_H
