 ...
 */
#ifndef _WEAVE_DATA_MANAGEMENT_PROTOCOL_ENGINE_H
#define _WEAVE_DATA_MANAGEMENT_PROTOCOL_ENGINE_H
...
#include <Weave/Profiles/data-management/Legacy/ProtocolEngine.h>
#else
...
#endif // _WEAVE_DATA_MANAGEMENT_PROTOCOL_ENGINE_H
