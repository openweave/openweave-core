...
/**
 *    @file
 *      This file is the umbrella header for the Development Generation Bulk
 *      Data Transfer profile.
 *
 */

#ifndef _WEAVE_BDX_DEVELOPMENT_HPP
#define _WEAVE_BDX_DEVELOPMENT_HPP
...
/**
 *   @namespace nl::Weave::Profiles::BDX_Development
 *
 *   @brief
