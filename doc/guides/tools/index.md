...
[`weave-heartbeat`](#weave-heartbeat) | Send and receive <a href="https://openweave.io/guides/weave-primer/profiles#heartbeat">Heartbeat</a> profile messages | `/src/test-apps`
`weave-key-export` | Send key export requests | `/src/test-apps`
[`weave-ping`](#weave-ping) | Send and receive <a href="https://openweave.io/guides/weave-primer/profiles#echo">Echo</a> profile messages | `/src/test-apps`
