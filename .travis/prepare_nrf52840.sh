...
# Create a symbolic link from openweave-nrf52840-lock-example/third_party/openweave-core to
# the OpenWeave source directory.  This will result in the demo app being
# built using the target OpenWeave commit.
#
rmdir ${TRAVIS_BUILD_DIR}/openweave-nrf52840-lock-example/third_party/openweave-core || exit 1
ln -s ${TRAVIS_BUILD_DIR} ${TRAVIS_BUILD_DIR}/openweave-nrf52840-lock-example/third_party/openweave-core || exit 1
