...
#define CONFIG_MAX_UNSOLICITED_MESSAGE_HANDLERS 16
#define CONFIG_MAX_EXCHANGE_CONTEXTS 8
#define CONFIG_WRMP_TIMER_DEFAULT_PERIOD 50
#define CONFIG_SHORT_ERROR_STR 0
#define CONFIG_MAX_SESSION_KEYS 8
#define CONFIG_USE_APP_GROUP_KEYS_FOR_MSG_ENC 1
#define CONFIG_MAX_CACHED_MSG_ENC_APP_KEYS 5
#define CONFIG_MAX_APPLICATION_EPOCH_KEYS 4
#define CONFIG_MAX_APPLICATION_GROUPS 4
#define CONFIG_DEFAULT_SECURITY_SESSION_ESTABLISHMENT_TIMEOUT 30000
#define CONFIG_DEFAULT_SECURITY_SESSION_IDLE_TIMEOUT 15000
#define CONFIG_SECURITY_TEST_MODE 1
#define CONFIG_DISABLE_PROVISIONING_AUTH 1
#define CONFIG_DEBUG_CERT_VALIDATION 0
#define CONFIG_ENABLE_PASE_INITIATOR 0
#define CONFIG_ENABLE_PASE_RESPONDER 1
#define CONFIG_ENABLE_CASE_INITIATOR 1
#define CONFIG_ENABLE_CASE_RESPONDER 1
#define CONFIG_MAX_WDM_SUBSCRIPTION_CLIENTS 2
#define CONFIG_MAX_WDM_SUBSCRIPTION_HANDLERS 2
#define CONFIG_MAX_WDM_NOTIFIES_IN_FLIGHT 2
#define CONFIG_MAX_WDM_NOTIFY_SIZE 2048
#define CONFIG_MIN_WDM_NOTIFY_BUFFER_SIZE 1024
#define CONFIG_MAX_WDM_RESUBSCRIBE_INTERVAL 5538000
#define CONFIG_WDM_ENABLE_SCHEMA_CHECK 1
...
#define WEAVE_CONFIG_ERROR_TYPE ret_code_t
#define WEAVE_CONFIG_NO_ERROR NRF_SUCCESS
